            ...
            <div>
              <q-stepper v-model="step" vertical color="primary" animated flat>
                <q-step
                  ...
                  :done="step > 1"
                >
                  Ứng dụng của bạn đang chạy trên nền tảng nào? Chúng tôi sẽ
                  cung cấp cho bạn một số nền tảng phổ biến để bắt đầu. Nếu
                  không rõ nền tảng sử dụng, chọn tự động phát hiện nền tảng ở
                  dưới cùng.
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-6 col-md-3 cursor-pointer">
                        <q-icon
                          ...
                          size="4em"
                          color="primary"
                          @click="selectPlatform('nodejs')"
                        />
                      </div>
                      <div class="col-xs-6 col-md-3 cursor-pointer">
                        <q-icon
                          name="fa-brands fa-php"
                          size="4em"
                          color="primary"
                          @click="selectPlatform('php')"
                        />
                      </div>
                      <div class="col-xs-6 col-md-3 cursor-pointer">
                        <q-icon
                          ...
                          size="4em"
                          color="primary"
                          @click="selectPlatform('vue')"
                        />
                      </div>
                      <div class="col-xs-6 col-md-3 cursor-pointer">
                        <q-icon
                          name="fa-solid fa-magic-wand-sparkles"
                          size="4em"
                          color="primary"
                          @click="selectPlatform('auto')"
                        />
                      </div>
                    </div>
                  </q-stepper-navigation>
                ...
                <q-step
                  ...
                  :done="step > 2"
                >
                  Chọn cấu hình cho ứng dụng của bạn. Cấu hình này sẽ ảnh hưởng
                  đến khả năng xử lý của ứng dụng của bạn. Ứng dụng của bạn có
                  thể chạy trên nhiều đơn vị xử lý cùng một lúc. Việc chọn cấu
                  hình dưới đây sẽ cài đặt cấu hình cho mỗi đơn vị.
                  <div class="units">
                    <div class="row">
                      <div
                        v-for="u in units"
                        :key="u.id"
                        class="col-xs-6 col-md-3 q-pa-md cursor-pointer"
                      >
                ...
                <q-step :name="4" title="Xác nhận thông tin" icon="add_comment">
                  <div class="confirm">
                    <div class="row">
...
export default {
  setup() {
    ...
    const units = [
      {
        id: "c100_m100",
        name: "1000 MB RAM, 1 CPU",
        price: 1000,
      },
      {
        id: "c200_m200",
        name: "2000 MB RAM, 2 CPU",
        price: 2000,
      },
      {
        id: "c500_m500",
    ...
    return {
      ...
      appNameRules: [
        ...
        (value) =>
          value.length <= 100 || "Tên ứng dụng không được quá 100 ký tự",
        (value) =>
          /^[a-z0-9-]+$/.test(value) ||
          "Tên ứng dụng chỉ được chứa các ký tự a-z, 0-9 và dấu -",
      ],
      nameRef,
    };
  },
